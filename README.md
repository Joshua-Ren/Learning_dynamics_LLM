...
This repository contains the official code for the paper "[Learning Dynamics of LLM Finetuning](https://arxiv.org/pdf/2407.10490)".
...
## Reference
For technical details and full experimental results, please check [our paper](https://arxiv.org/pdf/2407.10490).
```
@misc{ren:llm_LD,
